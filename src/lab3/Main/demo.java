...
public class demo {
	...
	private void YuYi() {
		...
		// 语义分析出错表格
		semerrorListTbModel = new DefaultTableModel(new Object[][] {},new String[] { "出错类型", "出错原因", "出错字符" });
		// errorListTbModel.addRow(new Object[] { "出错", "类别","出错原因" ,"value"});
...
/**************开始*************************************************/
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFileChooser chooser = new JFileChooser("D:\\eclipse\\BianYi\\src\\lab3"); // 设置选择器
		...
		JButton btnNewButton_1 = new JButton("\u6D4B\u8BD5");//测试
		...
		JButton button = new JButton("\u8BCD\u6CD5\u5206\u6790");//词法分析按钮
		...
		JButton button_1 = new JButton("\u8BED\u6CD5\u5206\u6790");//语法分析按钮
		...
		JButton button_3 = new JButton("\u8BED\u4E49\u5206\u6790");//语义分析
		...
		JButton btnDfa = new JButton("DFA\u8F6C\u6362\u8868");//DFA表
		...
		JButton btnSlr = new JButton("SLR\u5206\u6790\u8868");//SLR分析表
		...
		JButton button_2 = new JButton("\u8BED\u4E49\u89C4\u5219");//语义规则
		...
		JButton buttonWF = new JButton("文法表");//grammerTable文发表按钮
...
public void initRecord(ArrayList<RreeSemanticRecord> treeSemanticRecord,ArrayList<SLRTree> slrTreeArray){
	...
	public void semanticTest(grammerTable[] grammerTable,ArrayList<SLRTree> slrTreeArray,ArrayList<RreeSemanticRecord> treeSemanticRecord,
		...
		//System.out.println("产生式：\t"+grammerTable[grammerNum].getName()+" -> "+grammerTable[grammerNum].getValue()[0]+"("+grammerTable[grammerNum].getValue().length +")" );
		//语法分析开始
		...
		for(int i=0;i<length;i++){
			...
			//System.out.println("产生式 "+grammerNum+" 最前");
		...
		//最后是否也有语义片段
		System.out.println("产生式 "+grammerNum+" 最后");
	...
	public int isExitSemanticRule(int grammerNum,int loc,grammerSemanticLoca[] grammersemanticLoca){
		System.out.println("产生式中的位置：\t"+loc);
	...
	public void record(grammerSemanticLoca[] grammersemanticLoca,ArrayList<SLRTree> slrTreeArray,
		...
		//System.out.println("-- 符号表大小： "+charTable.size());
